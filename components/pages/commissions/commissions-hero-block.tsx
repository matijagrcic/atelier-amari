import commissionsHero from "@/data/commissions/mock-commissions-hero.json"
import { Badge } from "@/components/ui/badge"
import { SectionShell } from "@/components/pages/shared/section-shell"

type CommissionsHeroData = {
  eyebrow: string
  headline: string
  description: string
}

export function CommissionsHeroBlock() {
  const data = commissionsHero as CommissionsHeroData
