import privateEventsProcess from "@/data/private-events/mock-private-events-process.json"
...
export function PrivateEventsProcessBlock() {
  const data = privateEventsProcess as PrivateEventsProcessData
