import workshopsHero from "@/data/workshops-and-classes/mock-workshops-hero.json"
import { Badge } from "@/components/ui/badge"
import { SectionShell } from "@/components/pages/shared/section-shell"

type WorkshopsHeroData = {
  eyebrow: string
  headline: string
  description: string
}

export function WorkshopsHeroBlock() {
  const data = workshopsHero as WorkshopsHeroData
